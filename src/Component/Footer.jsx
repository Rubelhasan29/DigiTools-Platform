...
const Footer = () => {
    return (
        <div>
            ...
            <div className="bg-info-content  border-t-2 border-gray-400">
                <div className="max-w-10/12 mx-auto footer sm:footer-horizontal text-white pb-20 justify-between pt-10">
                    <div>
