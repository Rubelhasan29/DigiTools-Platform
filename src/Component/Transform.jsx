...
const Transform = () => {
    return (
        <div className="bg-accent mt-15 text-center space-y-20 lg:text-start lg:flex justify-center gap-70 p-15 lg:p-32">
            <div>
                <h1 className="text-2xl lg:text-6xl font-bold">Ready to Transform Your Workflow?</h1>
